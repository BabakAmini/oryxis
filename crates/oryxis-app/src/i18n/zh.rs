...
pub(super) fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "copy_password" => "复制密码",
        "no_password_stored" => "此主机未存储密码",
        "copied_clears_in" => "已复制（剪贴板将在 {secs} 秒后清空）",
        ...
        "clipboard_clear_seconds" => "在此时间后清除已复制的凭据（秒，0 = 关闭）",
        "setting_clipboard_clear_desc" => "从主机菜单复制密码后，将在该延迟后从剪贴板中清除。普通的终端复制不受影响。",
        "api_url" => "API 地址",
