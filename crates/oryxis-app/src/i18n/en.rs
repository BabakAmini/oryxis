...
pub(super) fn lookup(key: &str) -> &'static str {
    match key {
        ...
        "biometric_unlock_setting" => "Biometric unlock",
        "biometric_unlock_desc" => "Unlock this app with your device's biometrics (Windows Hello, Touch ID) or, on Linux, your login keyring. Your master password is stored in the operating system's protected keystore and released after a presence check. This unlocks the app only; it is not SSH authentication, and the vault stays encrypted with your password either way.",
