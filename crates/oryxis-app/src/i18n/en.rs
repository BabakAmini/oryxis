...
pub(super) fn lookup(key: &str) -> &'static str {
    match key {
        ...
        "tab_tip_docker" => "Docker",
        "feature_docker" => "Docker",
        "feature_docker_desc" => "List and manage Docker containers, images, and docker-compose projects on a host, read over the open session. Adds a Docker sidebar tab. Nothing is installed on the host.",
        "docker_title" => "Docker",
        "docker_refresh" => "Refresh",
        "docker_listing" => "Reading Docker data\u{2026}",
        "docker_not_installed" => "Docker is not installed on this host.",
        "docker_no_daemon" => "Docker daemon is not running on this host.",
        "docker_no_containers" => "No containers found.",
        "docker_no_images" => "No images found.",
        "docker_no_compose" => "No docker-compose files found in the current directory.",
        "docker_no_session" => "No active SSH session.",
        "docker_filter" => "Filter\u{2026}",
        ...
        "docker_probe_failed" => "Could not read Docker data.",
        "docker_action_failed" => "The command did not finish.",
