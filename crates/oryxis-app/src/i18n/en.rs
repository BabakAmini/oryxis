...
pub(super) fn lookup(key: &str) -> &'static str {
    match key {
        ...
        "remote_desktop_target_host" => "Target host",
        "remote_desktop_target_port" => "Target port",
        "open_remote_desktop" => "Open remote desktop",
        "stop_remote_desktop" => "Stop remote desktop",
        "remote_desktop_opening" => "Opening remote desktop on 127.0.0.1:{port}",
