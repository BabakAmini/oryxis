...
pub(super) fn lookup(key: &str) -> &'static str {
    match key {
        ...
        "no_password_stored" => "No password stored for this host",
        "copied_clears_in" => "Copied (clipboard clears in {secs}s)",
        ...
        "clipboard_clear_seconds" => "Clear copied credentials after (seconds, 0 = off)",
        "setting_clipboard_clear_desc" => "When a password is copied from a host's menu, wipe it from the clipboard after this delay. Normal terminal copies are never touched.",
        "api_url" => "API URL",
        ...
        "tab_bar_position_desc" => "Bottom docks the tab strip above the status bar; the window buttons stay in a slim top bar.",
