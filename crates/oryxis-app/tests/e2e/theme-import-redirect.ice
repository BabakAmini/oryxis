...
# fold. The wheel is what reaches it: the sidebar search finds the row
# (2 matches) but neither typing nor Enter scrolls it into view under the
# emulator, so a search-driven walk fails here instead of in the app.
click (1175, 64)
settle
click "Interface"
settle
...
# The paste travelled with the move: Import parses the scheme and opens
# the editor, which neither an empty panel nor the interface importer
# could produce.
click "Import"
settle
